...
class CheckOutScreen extends Component {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <Card style={{paddingHorizontal: dySize(15)}}>
            ...
            <TouchableOpacity onPress={this.gotoPostOptions}>
              <View style={styles.buttonLine}>
                <Text style={styles.buttonLineText}>POST OPTIONS</Text>
                <Icon name="ios-arrow-forward" style={styles.buttonLineIcon} />
              </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={this.gotoEditInstruction}>
              <View style={styles.buttonLine}>
                <Text style={styles.buttonLineText}>EDIT INSTRUCTIONS</Text>
                <Icon name="ios-arrow-forward" style={styles.buttonLineIcon} />
              </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={this.gotoDirectDebit}>
              <View style={styles.debitLine}>
                <Image source={DebitIcon} style={styles.icon} />
                <Text style={[styles.buttonLineText, { flex: 1 }]}>
                {selectedCard.name === undefined ? 'DIRECT DEBIT' : selectedCard.name}
                </Text>
                <Icon name="ios-arrow-forward" style={styles.buttonLineIcon} />
              </View>
            </TouchableOpacity>
            ...
            <View style={styles.modalView}>
              <View style={styles.modalTopView}>
                <View style={styles.messageView}>
                  <Text style={styles.modalBigText}>NO PAYMENT</Text>
                  <Text style={styles.modalBigText}>METHOD</Text>
                  <Text style={styles.modalSmallText}>Please add a payment method to continue.</Text>
                </View>
                <View style={styles.modalLogoView}>
                  <Image source={LogoImage} style={styles.logoImage} />
                </View>
              </View>
              <ButtonWithIcon
  ...
  onPressConfirm = () => {
    if(this.props.post.selectedCard.name === undefined) {
      this.showModal()
    } else {
...
export default connect(state => ({
  post: state.post,
}), mapDispatchToProps)(CheckOutScreen);
