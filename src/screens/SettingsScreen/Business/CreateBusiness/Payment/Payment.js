...
class CreateBusinessPaymentAddScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: '',
      ...
      <View style={styles.container}>
        ...
        <Content contentContainerStyle={{flex: 1}}>
          ...
          <View style={styles.bottomView}>
            <Text style={styles.bottomText}>We need the business payment details to charge and pay all hired Stint Students.</Text>
            <ButtonWithIcon
              text="NEXT"
...
export default connect(state => ({
  user: state.user,
}), mapDispatchToProps)(CreateBusinessPaymentAddScreen);
